...
Not very much. It can do arithmetic operations on numbers, print things or perform basic syscals, use procedure arguments, and convert between certain types. Variable support was added with tonight's nightly, and floating point and signed integer support will be worked on with tommorrow's nightly. It is planned to be expanded drastically further.
